            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    @endif
                     ...
                     {!! Form::open(['url' => URL::to('member-admin'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                    
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Name</label>
    <div class="col-sm-10">
        {!! Form::text('title', Input::old('title'),array('class' => 'form-control' , 'placeholder' => 'Enter name correctly' )) !!}
    </div>
    <br>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        {!! Form::text('description', Input::old('description'),array('class' => 'form-control' , 'placeholder' => 'Enter designation of member' )) !!}
    </div>
    <br>
</div>

<div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Member Type</label>
    <div class="col-sm-10">
        
        {!! Form::text('weight', Input::old('weight'),array('class' => 'form-control' , 'placeholder' => 'Enter weight' )) !!}
      ...
      <tr>
        ...
        <td>{{$member['description']}}</td>
         <td>{{$member['weight']}}</td>
          ...
          <td>{!! Form::open(['url' => URL::to('member-admin/'.$member->id),"method"=>"DELETE"]) !!}
                                                    <button type="submit" class="btn btn-xs btn-danger"><i class="fa  fa-trash-o"></i></button>
                                                {!! Form::close() !!}</td>
          <td>
          <td>
                                                <a href="{{ URL::to('member-admin/'.$member->id.'/edit') }}" class="btn btn-sm btn-icon btn-primary"><i class="fa fa-edit"></i></a>
                                            </td>
        </td>
