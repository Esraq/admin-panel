            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    @endif
                     ...
                     {!! Form::open(['url' => URL::to('menu_store'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                    
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Menu Name:</label>
    <div class="col-sm-10">
        {!! Form::text('name', Input::old('name'),array('class' => 'form-control' , 'placeholder' => 'Enter name of menu' )) !!}
    </div>
    <br>
...
<div class="form-group">
  ...
  {!! Form::text('destination', Input::old('destination'),array('class' => 'form-control' , 'placeholder' => 'Enter link' )) !!}
...
@endif
    ...
    @foreach($menus as $menu)
      <tr>
        ...
        <td> <a href="{{ URL::to('delete/'.$menu->id) }}" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-edit"></i></a></td>
         <td> <a href="{{ URL::to('edit_menu_view/'.$menu->id) }}" class="btn btn-sm btn-icon btn-primary"><i class="fa fa-edit"></i></a></td>
