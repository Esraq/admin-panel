            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    @endif
                     ...
                     {!! Form::open(['url' => URL::to('notice_store'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                     @csrf
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Notice Date</label>
    <div class="col-sm-10">
        {!! Form::date('number', Input::old('number'),array('class' => 'form-control' , 'placeholder' => 'Enter number correctly else error will take place' )) !!}
    </div>
    <br>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Notice Title</label>
    <div class="col-sm-10">
    ...
    @foreach($notices as $notice)
      <tr>
        ...
        <td>
         ...
         <td> <a href="{{ URL::to('delete_notice/'.$notice->id) }}" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-edit"></i></a>

        <td> <a href="{{ URL::to('edit_notice_view/'.$notice->id) }}" class="btn btn-sm btn-icon btn-primary"><i class="fa fa-edit"></i></a>
