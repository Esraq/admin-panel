            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <ul>   
                     ...
                     {!! Form::open(['url' => URL::to('comitee-admin'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                     @csrf


<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Comitee Year Title</label>
    <div class="col-sm-10">
...
@endif
    ...
    @foreach($items as $item)
     ...
     <td>{!! Form::open(['url' => URL::to('comitee-admin/'.$item->id),"method"=>"DELETE"]) !!}
