        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    ...
                    @endif
                     <h2>About Us</h2> 
                     {!! Form::open(['url' => URL::to('about_store'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                     @csrf
...
<div class="form-group">
    ...
    <div class="col-sm-10">
         ...
         {!! Form::textarea('short_description', Input::old('short_description'),array('class' => 'sms form-control','placeholder'=>'short description with 20 characters minimum','rows'=>'5')) !!}
    </div>
    <br>
</div>
<br>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
         ...
         {!! Form::textarea('description', Input::old('description'),array('class' => 'sms form-control','placeholder'=>'Main description text, with in 260  character','rows'=>'10')) !!}
    </div>
    <br>
    <br>
</div>
    ...
    @foreach($abouts as $about)
      <tr>
        ...
        <td>{{$about['description']}}</td>
         ...
         <td> <a href="{{ URL::to('delete_about/'.$about->id) }}" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-edit"></i></a>

        <td> <a href="{{ URL::to('edit_about_view/'.$about->id) }}" class="btn btn-sm btn-icon btn-primary"><i class="fa fa-edit"></i></a>
