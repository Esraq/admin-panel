            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <ul>   
                     ...
                     {!! Form::open(['url' => URL::to('document_store'),'id'=>'event', 'enctype'=>'multipart/form-data']) !!}
                     @csrf


<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Document Title</label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Upload Document</label>
    <div class="col-sm-10">
        
         {!! Form::file('filename', Input::old('filename'),array('class' => 'sms form-control','placeholder'=>'Main description text, with in 260  character')) !!}
    </div>
    <br>
</div>
    ...
    @foreach($documents as $document)
      <tr>
        ...
        <td>{{$document->filename}}</td>
         ...
         <td> <a href="{{ URL::to('delete_document/'.$document->id) }}" class="btn btn-sm btn-icon btn-danger"><i class="fa fa-edit"></i></a></td>
